...
Remontée de données des partenaires<br><br>Saisie sur GéObs (<a href='https://geobs.eaufrance.fr/'>https://geobs.eaufrance.fr/</a>)<br><br>Validation obligatoire par un agent de l’OFB disposant du profil validation
:::
::: {.column width="5%"}
:::
::: {.column width="35%"}
...
<div class="card">
  ...
  <a href='file://ad.intra/dfs/COMMUNS/REGIONS/IDF/DR/05_CONNAISSANCE/ROE/04_Bilans' target='_blank'>Bilans (serveur DR)</a><br>
